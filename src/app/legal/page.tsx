...
/**
 * Legal & Compliance Industry Page.
 * URL: /legal
 *
          ...
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-extrabold text-white leading-tight tracking-tighter">
                Legal & <br/><span className="text-white/40">Compliance Ops.</span>
              </h1>
              <p className="text-lg text-white/40 mt-6 max-w-lg leading-relaxed font-light">
                Placing Attorneys, Paralegals, Compliance Officers, and Legal Technology professionals across law firms and in-house departments.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-4">
                <Link href="/job-opportunities" className="ci-pill-btn ci-pill-btn-primary group">
                  Browse Legal Feed <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-all" />
                </Link>
        ...
        <section className="bg-black relative overflow-hidden">
          ...
          <div className="ci-container py-24 relative z-10">
            <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#a4f07a] mb-4 block">Legal Disciplines</span>
        ...
        <section className="bg-[#050505] border-t border-white/5 relative overflow-hidden">
          ...
          <div className="ci-container py-24 relative z-10 text-center lg:text-left">
            <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div>
                <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">Initiate Legal Acquisition.</h2>
                <p className="text-lg text-white/30 mt-4 max-w-xl font-light">Attorney or hiring manager — activate the protocol within 24 hours.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 shrink-0">
                <Link href="/job-opportunities" className="ci-pill-btn ci-pill-btn-primary group">
                  Browse Legal Roles <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-all" />
                </Link>
                <Link href="/consult-with-us" className="ci-pill-btn ci-pill-btn-outline">
                  Deploy Talent
                </Link>
